            ...
            <div className="about-text">
              {avatarSrc && (
                <div style={{ marginBottom: 24 }}>
                  ...
                  <img src={avatarSrc} alt={profile.name} style={{ width: 180, height: 180, borderRadius: "16px", objectFit: "contain", border: "3px solid var(--accent-primary)", background: "var(--bg-secondary)" }} />
                </div>
              )}
