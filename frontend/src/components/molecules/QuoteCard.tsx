...
export const QuoteCard: React.FC<QuoteCardProps> = ({
  ...
  const containerClasses = `relative max-w-xs sm:max-w-sm rounded-2xl bg-white/95 backdrop-blur-md border border-black/10 shadow-xl shadow-black/5 p-4 sm:p-5 select-none ${className}`;

  const content = (
    <>
      {/* Prominent Coral Quote Symbol */}
      <div className="w-8 h-8 rounded-xl bg-[#FFF1EE] text-[#FF462E] flex items-center justify-center shrink-0 mb-3 shadow-xs">
